...
async function load() {
  plans.value = await adFreePlanApi.list();
}
...
async function save() {
  ...
  if (editing.value) {
    await adFreePlanApi.update(editing.value.id, payload);
  } else {
    await adFreePlanApi.create(payload);
  }
...
async function remove(row) {
  ...
  await adFreePlanApi.remove(row.id);
